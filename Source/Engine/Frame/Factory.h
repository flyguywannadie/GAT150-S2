...
#define CREATE_CLASS(classname) max::Factory::Instance().Create<max::classname>(#classname)
#define CREATE_CLASS_BASE(classbase, classname) max::Factory::Instance().Create<max::classbase>(classname)
#define INSTANTIATE(classbase, classname) max::Factory::Instance().Create<max::classbase>(classname)
